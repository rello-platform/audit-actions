...
const EXACT_REGISTRY_DATA = {
  ...
  soft_deleted: {
    ...
    kind: "crud_composite",
    description:
      "Soft-delete (deactivate without hard-delete) state mutation — e.g. NS tenant soft-delete (CHURNED + isActive=false) via newsletter-studio.audit.tenant.soft_deleted.",
  },
